    ...
    regions: [
      {
        ...
        note: "Expected divergent BY DECISION 3 (the Arabic issue wins): the eight steps' Arabic is verbatim from the Arabic issue of the plan form, superseding the prototype's compressed Arabic; the English side follows the reference. The facility EMS number matches (01 372 802). UNVERIFIED as to geometry, numbering and the emergency-number strip: no reference-side locator.",
      },
      {
        name: 'derived',
        mode: 'compare',
  ...
  // --- Slice 5: the counterparty roles ---
  {
    ...
    regions: [
      ...
      },
      {
        ...
        note: "Expected divergent, seed continuity over pixel parity: the reference invitation is the Baalbeck Level 3 showcase; the built route is the still-nominated Coastal Medical token from the organizer's Slice 2 seed (the demonstration data holds one organizer). UNVERIFIED as to layout and labels: no reference-side locator.",
      },
    ],
  },
  {
