        ...
        <div data-region="package-docs" style={{ maxWidth: 900 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBlockEnd: 44 }}>
            {documents.map((d) => {
              ...
              return (
                <div key={d.key} style={{ padding: '18px 22px', background: 'var(--surface2)', borderInlineStart: `3px ${d.thirdParty ? 'dashed' : 'solid'} ${color}`, borderRadius: 12, display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'space-between', alignItems: 'center' }}>
