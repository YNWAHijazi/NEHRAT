  ...
  return (
    <>
      ...
      <main data-pad="" style={{ maxWidth: 1160, marginInline: 'auto', padding: '44px 32px 120px' }}>
        ...
        <div data-region="different-actor" style={{ padding: '20px 24px', background: 'var(--surface2)', borderRadius: 12, marginBlockEnd: 40, maxWidth: '80ch', fontSize: '14.5px', lineHeight: 1.7, color: 'var(--muted)' }}>
        ...
        <div data-region="non-transport" style={{ padding: '18px 22px', background: 'var(--surface2)', borderRadius: 12, marginBlockEnd: 40, fontSize: '14.5px', lineHeight: 1.7, maxWidth: '80ch' }}>
          <L en={content.nonTransportRule.en} ar={content.nonTransportRule.ar} />
        </div>

        <div data-region="reports" style={{ padding: '24px 28px', background: 'var(--surface2)', borderRadius: 16, maxWidth: '80ch' }}>
