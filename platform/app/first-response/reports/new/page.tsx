    ...
    <>
      ...
      <main data-pad="" style={{ maxWidth: 1160, marginInline: 'auto', padding: '44px 32px 120px' }}>
        <div style={{ maxWidth: 900 }}>
          ...
          <DatasetForm />
          <div data-region="timeframe" style={{ marginBlockStart: 20, padding: '18px 22px', background: 'var(--surface2)', borderRadius: 12, fontSize: '13.5px', lineHeight: 1.7, color: 'var(--muted)', maxWidth: '80ch' }}>
            {timeframe ? (
              <L
