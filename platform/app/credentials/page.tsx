    ...
    <>
      ...
      <main data-pad="" style={{ maxWidth: 1160, marginInline: 'auto', padding: '44px 32px 120px' }}>
        <div style={{ maxWidth: 900 }}>
          ...
          <div data-region="non-determinative" style={{ padding: '22px 26px', background: 'var(--surface2)', borderRadius: 12, fontSize: '14.5px', lineHeight: 1.7, color: 'var(--muted)', maxWidth: '82ch' }}>
