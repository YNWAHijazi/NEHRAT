        ...
        {serious.length === 0 ? (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {serious.map((r) => {
              ...
              return (
                <a key={`${r.eventId}-${r.notifiedAt}`} href={`/ministry/submissions/${r.eventId}`} style={{ paddingBlock: '13px', paddingInlineStart: '16px', paddingInlineEnd: '17px', background: 'var(--surface2)', borderInlineStart: `3px solid ${inWindow ? 'var(--brand)' : 'var(--bad)'}`, borderRadius: 10, display: 'flex', flexWrap: 'wrap', gap: 14, fontSize: '13.5px', alignItems: 'baseline', textDecoration: 'none', color: 'var(--ink)' }}>
        ...
        <div>
          ...
          <div data-region="post-event" style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {postEvent.map((r) => {
              ...
              return (
                <div key={r.id} style={{ paddingBlock: '15px', paddingInlineStart: '18px', paddingInlineEnd: '19px', background: 'var(--surface2)', borderInlineStart: `3px solid ${flagged ? 'var(--bad)' : 'var(--brand)'}`, borderRadius: 10, display: 'flex', flexWrap: 'wrap', gap: 12, justifyContent: 'space-between' }}>
        ...
        <div>
          ...
          <div data-region="cardiac" style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {facilityIncidents.map((r, i) => {
              ...
              return (
                <div key={`f-${i}`} style={{ paddingBlock: '15px', paddingInlineStart: '18px', paddingInlineEnd: '19px', background: 'var(--surface2)', borderInlineStart: '3px solid var(--accent)', borderRadius: 10, fontSize: '14.5px' }}>
