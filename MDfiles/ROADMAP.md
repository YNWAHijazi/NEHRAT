...
| Screen | Route | Reached from |
|---|---|---|
| **Nomination and account** | `/invitations/:id` | The organizer's invitation email |
...
| Screen | Route | Reached from |
|---|---|---|
| **Nomination and account** | `/invitations/:id` | The organizer's nomination |
...
**18 screens across four permission levels.** A reviewer sees the first group; administrator screens are marked; two screens belong to the platform owner alone.
...
- **Deadline dates** — from the level and the event date. 7, 14 or 30 calendar days before.
