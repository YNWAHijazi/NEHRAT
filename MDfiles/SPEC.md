...
Then a set of **minimum conditions** applies — nine of them, e.g. 20,000 or more people present at the same time forces Level 3 regardless of score. **The final level is the higher of the two results.** Show both and show which one governed; an organizer who scored 9 but lands at Level 3 must be able to see why.
